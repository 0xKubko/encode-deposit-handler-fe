...
import { removeManager } from "../functions/BootcampFactory/addManager";
...
export default function RemoveManager() {
    ...
    return (
        <div>
            <button className="btn" onClick={() => setVisible(true)}>Remove Manager</button>
            <Modal visible={visible}>
                <h3 className="font-bold text-lg">Remove Manager</h3>
                <input
                    type="text"
